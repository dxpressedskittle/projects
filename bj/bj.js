...
function stand() {
    if (playerScore < dealerScore) {
        resultDisplay.innerText = "You can't stand when the dealer has a higher score! Hit again!"
    } else if (dealerScore == playerScore) {
        resultDisplay.innerText = "You can't stand when the dealer has the same score! Hit again!"
...
function resultDisplayReset() {  // clear results
...
shuffleButton.addEventListener('click', function() { //shuffle addEventListener
